 ...
 */
public record MaterialDefinition(String descriptionId, Ingredient ingredient,
    ...
    public static final Codec<MaterialDefinition> CODEC = RecordCodecBuilder.create(builder -> builder.group(
            ...
            net.minecraft.resources.Identifier.CODEC.fieldOf("paletteLocation").forGetter(MaterialDefinition::paletteLocation),
