...
public class ModelTypeRegistry {
    private static final DeferredRegister<ModelType> MODEL_TYPES = DeferredRegister.create(io.redspace.ironsjewelry.api.ModelTypeRegistry.MODEL_TYPE_REGISTRY_KEY, IronsJewelry.MODID);
